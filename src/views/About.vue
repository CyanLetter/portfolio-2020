<template>
	<section class="about">
		...
		<footer>
			...
			<a href="https://www.linkedin.com/in/dakota-ling-67754557/" target="_blank">
				<inline-svg :src="this.linkedinIcon" alt="Land of Recruiters"></inline-svg>
			</a>
		</footer>
	</section>
</template>
